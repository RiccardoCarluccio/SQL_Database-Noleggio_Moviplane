...
{
    internal class Noleggio_Automobile : Noleggio
    {
        public Noleggio_Automobile(string codice, string nominativo, DateTime data_ritiro, DateTime data_consegna, int giorni_noleggio, bool disponibilita, String descrizione) : base(codice, nominativo, data_ritiro, data_consegna, giorni_noleggio, disponibilita, descrizione)
        {
            this.codice = codice;
